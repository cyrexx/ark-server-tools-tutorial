...
In the first step, we install all required packages to run a full fledges ARK-Server. To manage the server, we add a new user to the system called _ARK_SERVER_USERNAME_. Please change this name in every step according to your setup.
