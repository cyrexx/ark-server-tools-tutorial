...
In this step we install the ARK Server-Tools and the steam command line tool steamcmd. Both are required to manager our ARK server instances efficiently.
